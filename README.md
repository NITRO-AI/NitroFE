...
``NitroFE`` is a Python feature engineering engine which provides a variety of modules designed to internally save past dependent values and provide continuous calculation.
